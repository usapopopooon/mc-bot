...
ITEM_GACHA_REWARDS = (
    ...
    ItemGachaReward("n_rocket", "N", "minecraft:firework_rocket", "ロケット花火", 48, 13),
    ItemGachaReward("n_xp_bottle", "N", "minecraft:experience_bottle", "エンチャントの瓶", 24, 13),
    ItemGachaReward("n_golden_carrot", "N", "minecraft:golden_carrot", "金のニンジン", 32, 13),
    ...
    ItemGachaReward("n_wind_charge", "N", "minecraft:wind_charge", "ウィンドチャージ", 16, 12),
    ItemGachaReward("n_chorus_fruit", "N", "minecraft:chorus_fruit", "コーラスフルーツ", 32, 12),
    ...
    ItemGachaReward("n_steak", "N", "minecraft:cooked_beef", "ステーキ", 32, 12),
    ItemGachaReward("n_cooked_porkchop", "N", "minecraft:cooked_porkchop", "焼き豚", 32, 12),
    ItemGachaReward("n_pumpkin_pie", "N", "minecraft:pumpkin_pie", "パンプキンパイ", 32, 12),
    ItemGachaReward("n_honey_bottle", "N", "minecraft:honey_bottle", "ハチミツ入りの瓶", 16, 12),
    ...
    ItemGachaReward("r_golden_apple", "R", "minecraft:golden_apple", "金のリンゴ", 3, 12),
    ItemGachaReward("r_shulker_shell", "R", "minecraft:shulker_shell", "シュルカーの殻", 2, 12),
    ItemGachaReward("r_breeze_rod", "R", "minecraft:breeze_rod", "ブリーズロッド", 8, 12),
    ItemGachaReward(
        "r_ominous_trial_key",
        "R",
    ...
    ItemGachaReward("n_nautilus_shell", "R", "minecraft:nautilus_shell", "オウムガイの殻", 4, 12),
    ItemGachaReward("r_echo_shard", "R", "minecraft:echo_shard", "残響の欠片", 4, 12),
    ItemGachaReward("r_heart_of_the_sea", "R", "minecraft:heart_of_the_sea", "海洋の心", 1, 12),
    ItemGachaReward(
        "r_recovery_compass",
        "R",
    ...
    ItemGachaReward("r_trial_key", "R", "minecraft:trial_key", "試練の鍵", 2, 12),
    ItemGachaReward(
        "r_netherite_upgrade",
        "R",
