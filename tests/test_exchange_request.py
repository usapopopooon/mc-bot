...
@pytest.mark.parametrize(
    ...
    [
        ...
        "diamond_emerald|minecraft:emerald|4|0|64",
        "material_buyback|minecraft:emerald|64|0|500",
...
@pytest.mark.parametrize(
    ...
    [
        ...
        "resource|minecraft:netherite-ingot|1|100|1",
        "resource|minecraft:diamond|65|100|65",
        "emerald_diamond|minecraft:diamond|16|0|1",
        "emerald_diamond|minecraft:diamond|32|100|1",
        "diamond_emerald|minecraft:emerald|2|0|32",
        "diamond_emerald|minecraft:diamond|1|0|16",
        "diamond_emerald|minecraft:emerald|1|0|32",
        "unknown|balance|0|0|0",
        "material_buyback|minecraft:diamond|64|0|500",
