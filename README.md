...
サーバーXP→資源、手持ちエメラルド→ダイヤモンド、通常資材→サーバーXP、XP残高確認を
利用できます。資材買取は土・砂・砂岩・深層岩・深層岩の丸石・凝灰岩を64個単位で扱い、
1人1日1,500サーバーXP（毎日0時・日本時間に更新）までです。名前や特殊データ付きの
...
「受注」と「依頼取消」があり、依頼取消は募集中の依頼主本人だけが実行できます。
