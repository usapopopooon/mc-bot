...
通常100 XPまたはR以上確定1,000 XPを選び、日本時間0:00区切りで両方合わせて1日3回まで
引けます。抽選前の確認画面に現在XPと抽選後のXPを表示します。公開するランク確率は、通常が
N 55%、R 28%、SR 11%、SSR 4%、UR 1.75%、幻 0.25%、R以上確定が
R 70%、SR 20%、SSR 7%、UR 2.5%、幻 0.5%です。景品内容と個別確率は抽選・受取が
